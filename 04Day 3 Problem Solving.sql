-- Create sales1 table and insert values in it.
...
select * from sales1;
-- Problem 1:
-- Use Case: Find customers who bought either a 'Kurti' or a 'Perfume' 
-- and whose quantity is greater than 1.

select customername, product,quantity
from sales1
where (Product = 'Kurti' or Product ='perfume') and quantity > 1;



-- Problem 2:
-- Use Case: Find all customers who bought a 'Kurti' but not in 'Mumbai'.

select customername, product, city
from sales1
where product= 'Kurti' and not city = 'Mumbai';



-- Problem 3:
-- Use Case: Find all customers who bought either a 'Leather Jacket' or a 'Gaming Laptop' 
-- but with a discount of more than 30%.
select CustomerName, Product, DiscountPercent
from sales1
where (Product = 'Leather Jacket' or Product = 'Gaming Laptop') and discountPercent > 30;


## 2. Comparison Operators (>, <, >=, <=, =, !=)
-- Problem 4:
-- Use Case: Find customers who spent more than 5000 on a single item.
select CustomerName, Product, price, Quantity
from sales1
where price > 5000 and Quantity = 1;


-- Problem 5:
-- Use Case: Find customers who bought 'Nike Shoes' at a price greater than or equal to 4999 
-- but with a discount less than 20%.
select customername, product,Price, discountPercent
from sales1
where Product = 'Nike Shoes' and Price >= 4999 and discountPercent < 20;


## 3. Range Operators (BETWEEN...AND)
-- Problem 6:
-- Use Case: Find customers who bought products within the price range of 2000 to 5000.
select customername, product,Price 
from sales1 
where price between 2000 and 5000;


## Problem 7:
-- Use Case: Find customers who purchased between '2023-01-01' and '2024-01-01'.
select customername, product, saledate
from sales1
where saledate between '2023-01-01' and '2024-01-01';

## 4. Membership Operators (IN)
-- Problem 8:
-- Use Case: Find all customers who bought 'Nike Shoes', 'Perfume', or 'Kurti'.
select Customername, product
from sales1
where product in ('Nike Shoes','Perfume','Kurti');
 
## 5. Search Operators (LIKE, IS NULL)
-- Problem 9:
-- Use Case: Find customers whose names start with 'A' and bought a 'Kurti'.
select Customername, product
from sales1
where customername like 'A%' and product = 'Kurti';

-- Problem 10:
-- Use Case: Find customers whose email is NULL.
select Customername 
from sales1 
where CustomerEmail is NULL; -- no records having null email id


## Combination Problems (2 Operators)
-- Problem 11:
-- Use Case: Find customers who bought either a 'Gaming Laptop' or 'Nike Shoes' 
-- and whose discount percentage is greater than 25%.

select customername,product,discountpercent
from sales1
where Product in ('Gaming Laptop', 'Nike Shoes')
and DiscountPercent > 25;

-- Problem 12:
-- Use Case: Find customers who bought 'Microwave Oven' 
-- and whose price is between 15000 and 30000, 
-- but discount is not equal to 20%.

select customername,product,price,discountpercent
from sales1
where Product = 'Microwave Oven'
and Price between 15000 and 30000
and DiscountPercent != 20;

-- Problem 13:
-- Use Case: Find customers who bought a 'Kurti' and whose quantity is either 1 or 3.
...
-- Problem 14:
-- Use Case: Find customers who bought 'Washing Machine' 
-- and whose delivery address contains 'Marg'.

select customername,product,deliveryaddress
from sales1
where Product = 'Washing Machine'
and DeliveryAddress like '%Marg%';
  
  use classess;
-- Problem 15:
-- Use Case: Find customers who bought either a 'Leather Jacket' or 'Smartwatch' 
-- in the city 'Mumbai' or 'Delhi'.
select customername,product,city
from sales1
where Product in ('Leather Jacket', 'Smartwatch')
and City in ('Mumbai', 'Delhi');

## Combination Problems (3-4 Operators)
-- Problem 16:
-- Use Case: Find customers who bought a 'Smartwatch', 
-- whose quantity is greater than or equal to 1, 
-- and whose payment method is 'COD' or 'UPI'.

select customername,product,quantity,paymentmethod
from sales1
where Product = 'Smartwatch'
and Quantity >= 1
and PaymentMethod in ('COD', 'UPI');

-- OR using OR operator instead of IN

select customername,product,quantity,paymentmethod
from sales1
where Product = 'Smartwatch'
and Quantity >= 1
and (PaymentMethod = 'COD' OR PaymentMethod = 'UPI');


-- Problem 17:
-- Use Case: Find customers who bought a 'Kurti' or 'Perfume' 
-- between '2023-01-01' and '2024-01-01', 
-- with a discount of 20% or higher.

select customername,product,saledate,discountpercent
from sales1
where Product in ('Kurti', 'Perfume')
and SaleDate between '2023-01-01' and '2024-01-01'
and DiscountPercent >= 20;

-- Problem 18:
-- Use Case: Find customers who bought a 'Nike Shoes' or 'Perfume', 
-- whose quantity is between 2 and 5, 
-- and whose payment method is 'UPI' or 'Card'.

select customername,product,quantity,paymentmethod
from sales1
where Product in ('Nike Shoes', 'Perfume')
and Quantity between 2 and 5
and PaymentMethod in ('UPI', 'Card');

-- Problem 19:
-- Use Case: Find customers who bought either 'Kurti' or 'Nike Shoes' 
-- with a discount of 10% or 20%, 
-- whose city is either 'Mumbai' or 'Delhi', 
-- and whose price is less than 5000.

select customername,product,discountpercent,city,price
from sales1
where Product in ('Kurti', 'Nike Shoes')
and DiscountPercent in (10, 20)
and City in ('Mumbai', 'Delhi')
and Price < 5000;

-- Problem 20:
-- Use Case: Find customers who bought 'Kurti' or 'Perfume', 
-- whose discount is more than 20%, 
-- and whose sale date is in 2023.

select customername,product,discountpercent,saledate
from sales1
where Product in ('Kurti', 'Perfume')
and DiscountPercent > 20
and SaleDate between '2023-01-01' AND '2023-12-31';
