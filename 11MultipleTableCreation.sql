-- Draw ER Diagram 
-- Refer School database and draw ER Diagram
-- Create Multiple tables and insert records into it
...
-- 1️ View all branches
SELECT * FROM branches;

-- 2️ View all departments
SELECT * FROM department;

-- 3️ View all employees
SELECT * FROM employee;

-- 4️ View all classes
SELECT * FROM classes;

-- 5️ View all teachers
SELECT * FROM teachers;

-- 6️ View all students
SELECT * FROM students;

-- 7️ View all fees
SELECT * FROM fees;

-- 8️ View teacher-class assignments
